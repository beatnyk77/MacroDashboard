...
export const US_MACRO_METRICS = {
  ...
  US_FISCAL_INTEREST_TO_RECEIPTS_PCT:      'US_FISCAL_INTEREST_TO_RECEIPTS_PCT',
  US_FISCAL_INTEREST_TO_GDP_PCT:           'US_FISCAL_INTEREST_TO_GDP_PCT',
  US_FISCAL_MANDATORY_TO_RECEIPTS_PCT:     'US_FISCAL_MANDATORY_TO_RECEIPTS_PCT',
  US_FISCAL_ENTITLEMENTS_TO_RECEIPTS_PCT:  'US_FISCAL_ENTITLEMENTS_TO_RECEIPTS_PCT',
  US_FISCAL_EMPLOYMENT_TAX_SHARE_PCT:      'US_FISCAL_EMPLOYMENT_TAX_SHARE_PCT',
  US_PERSONAL_TAX_RECEIPTS:                'US_PERSONAL_TAX_RECEIPTS',
  US_PAYROLL_TAX_RECEIPTS:                 'US_PAYROLL_TAX_RECEIPTS',
  ...
  US_DEBT_MATURING_3M_TN:                  'US_DEBT_MATURING_3M_TN',
  US_DEBT_MATURING_6M_TN:                  'US_DEBT_MATURING_6M_TN',
  US_DEBT_MATURING_12M_TN:                 'US_DEBT_MATURING_12M_TN',
...
export const UST_METRICS = {
  ...
  US_TREASURY_10Y_BID_TO_COVER:            'US_TREASURY_10Y_BID_TO_COVER',
  US_TREASURY_10Y_INDIRECT_PCT:            'US_TREASURY_10Y_INDIRECT_PCT',
  US_TREASURY_10Y_PRIMARY_DEALER_PCT:      'US_TREASURY_10Y_PRIMARY_DEALER_PCT',
  US_TREASURY_10Y_DEMAND_SCORE:            'US_TREASURY_10Y_DEMAND_SCORE',
} as const;
