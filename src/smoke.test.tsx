...
const queryClient = new QueryClient({
    defaultOptions: {
        queries: {
            retry: false,
            // @ts-ignore - 'suspense' is technically deprecated in the types, but required to test Suspense components correctly without using experimental useSuspenseQuery
            suspense: true
        },
    },
});
