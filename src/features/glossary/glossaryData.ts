...
export const glossaryData: GlossaryTerm[] = [
    ...
    },
    {
        ...
        slug: 'tga',
        category: 'Liquidity',
        definition: 'The US government\'s primary operating account held at the Federal Reserve Bank of New York (FRED series: WTREGEN). TGA balances rise when the Treasury collects taxes or issues debt, draining dollars from the banking system. They fall when the government spends, injecting liquidity back. The TGA is therefore a structurally important off-balance-sheet liquidity lever for the Fed — as significant as quantitative easing or tightening in its mechanical effect on bank reserves.',
        formula: 'Net Liquidity = WALCL − WTREGEN (TGA) − RRPONTSYD\nΔ Reserves ≈ −Δ TGA (ceteris paribus)',
    ...
    },
    {
        ...
        formula: 'Fiscal Dominance Signal = Federal Interest Expense / Federal Tax Revenue × 100\nThreshold: >20% = fiscal dominance regime (historical precedent)',
    ...
    },
    {
        ...
        relatedMetrics: ['RBI DBIE Reserves Data', 'Import Cover Ratio', 'CAD/GDP', 'IMF COFER'],
    },
    ...
    {
        id: '38',
        term: 'CFTC Speculative Net Positioning',
        slug: 'cftc-cot-positioning',
        category: 'Macro Indicators',
        definition: 'A positioning measure derived from the Commodity Futures Trading Commission Commitment of Traders reports. It compares non-commercial long and short futures positions and places the resulting bias in historical context.',
        formula: 'Speculative Net Position = Non-commercial Longs − Non-commercial Shorts',
        whyItMatters: 'Crowded positioning changes the market impact of new information. Extreme net length can leave fewer marginal buyers, while extreme net short positioning can amplify a rebound.',
        relatedMetrics: ['CFTC Commitment of Traders', 'Open Interest', 'Futures Basis'],
    },
    {
        id: '39',
        term: 'China Debt Iceberg Ratio',
        slug: 'china-debt-iceberg',
        category: 'Sovereign Debt',
        definition: 'A framework for comparing China’s consolidated public-sector leverage with officially reported central-government debt. It brings local-government financing vehicles, policy banks, and contingent state liabilities into one surveillance lens.',
        formula: 'Iceberg Ratio = Consolidated Public-Sector Debt / Official Central-Government Debt',
        whyItMatters: 'Official debt data can understate the balance-sheet risk that matters for local refinancing, fiscal transfers, and policy capacity.',
        relatedMetrics: ['China Iceberg Ratio', 'LGFV Stress', 'China Debt Maturity Wall'],
        methodsPage: '/methods/china-debt-iceberg',
    },
    {
        id: '40',
        term: 'Fed Debt Monetization Ratio',
        slug: 'fed-monetization-ratio',
        category: 'Sovereign Debt',
        definition: 'A stock measure comparing Federal Reserve Treasury holdings with total public debt outstanding. It describes the share of sovereign debt absorbed by the central bank balance sheet.',
        formula: 'Monetization Ratio = Federal Reserve Treasury Holdings / Total Public Debt',
        whyItMatters: 'The ratio helps macro desks study the interaction between fiscal issuance, central-bank balance-sheet policy, and the market’s capacity to absorb Treasury supply.',
        relatedMetrics: ['Fed Debt Monetization Ratio', 'Fiscal Dominance Meter', 'Net Liquidity'],
        methodsPage: '/methods/fed-monetization-monitor',
    },
    {
        id: '41',
        term: 'G20 Fiscal Vulnerability',
        slug: 'g20-fiscal-vulnerability',
        category: 'Sovereign Debt',
        definition: 'A comparative sovereign-risk lens that combines debt-service pressure, fiscal balances, growth, and refinancing exposure across G20 economies.',
        whyItMatters: 'Cross-country fiscal comparisons help allocators separate headline debt levels from the refinancing and interest-cost conditions that determine policy room.',
        relatedMetrics: ['Public Debt to GDP', 'Interest Expense to Tax Revenue', 'Sovereign Stress Index'],
    },
    {
        id: '42',
        term: 'India Credit Cycle Clock',
        slug: 'india-credit-cycle-clock',
        category: 'Macro Indicators',
        definition: 'A two-axis framework that maps India’s bank-credit growth against the credit-to-deposit ratio to identify expansion, late-cycle, downturn, and repair phases.',
        formula: 'Phase = f(Credit Growth YoY, Credit-to-Deposit Ratio)',
        whyItMatters: 'The clock connects RBI policy transmission with banking-system leverage and helps distinguish healthy credit expansion from funding pressure.',
        relatedMetrics: ['India Credit Cycle Clock', 'Loan-to-Job Efficiency Ratio', 'RBI Repo Rate'],
        methodsPage: '/methods/india-credit-cycle-clock',
    },
    {
        id: '43',
        term: 'Treasury Auction Demand',
        slug: 'treasury-auction-demand',
        category: 'Sovereign Debt',
        definition: 'A measure of investor demand at US Treasury auctions using bid-to-cover, indirect participation, tail, and related auction statistics.',
        whyItMatters: 'Auction demand provides a direct read on marginal absorption of new sovereign supply and can reveal term-premium pressure before it appears in broader funding conditions.',
        relatedMetrics: ['Treasury Auction Demand', 'US Debt Maturity Wall', '10-Year Treasury Yield'],
    },
    {
        id: '44',
        term: 'US Debt Maturity Wall',
        slug: 'us-debt-maturity-wall',
        category: 'Sovereign Debt',
        definition: 'The scheduled concentration of US Treasury maturities that must be refinanced over a defined future window. It is a calendar measure of rollover exposure, not a default forecast.',
        whyItMatters: 'Large refinancing windows increase the sensitivity of fiscal costs to prevailing yields and investor demand for new issuance.',
        relatedMetrics: ['US Debt Maturity Wall', 'Treasury Auction Demand', 'Fiscal Dominance Meter'],
    },
    {
        id: '45',
        term: 'WTI Physical Stress',
        slug: 'wti-physical-stress',
        category: 'Hard Assets',
        definition: 'A physical oil-market stress lens built from WTI prompt spreads, inventory conditions, and related supply-demand signals. Backwardation indicates tighter prompt supply; contango indicates more available storage economics.',
        formula: 'Prompt Spread = Near-Month WTI − Deferred WTI',
        whyItMatters: 'The prompt curve can distinguish a paper-price move from a physical supply signal and provides context for energy-linked inflation risk.',
        relatedMetrics: ['WTI Physical Stress', 'WTI Prompt Spread', 'EIA Crude Inventories'],
    },
    {
        id: '46',
        term: 'China Monetization Pressure',
        slug: 'china-monetization-pressure',
        category: 'Sovereign Debt',
        definition: 'A surveillance concept for the pressure on Chinese monetary and fiscal authorities to absorb, refinance, or otherwise support public-sector liabilities as growth and property conditions change.',
        whyItMatters: 'Monetization pressure links local-government refinancing, bank balance sheets, credit creation, and the policy trade-off between growth support and currency stability.',
        relatedMetrics: ['China Monetization Pressure', 'China Iceberg Ratio', 'China Credit Impulse'],
    },
];
