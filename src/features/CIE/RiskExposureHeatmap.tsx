            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 px-8 py-6 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground/60 font-black uppercase tracking-widest mt-1">Sectoral exposure to systemic macro shocks</p>
                    </div>
                </div>
                ...
                <div className="flex bg-black/40 p-1.5 rounded-2xl border border-white/10 backdrop-blur-md">
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-xl text-xs font-black uppercase tracking-[0.2em] transition-all opacity-30 cursor-not-allowed`}
                        disabled
                    >
                        Drill-down
                    </button>
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b border-white/5 bg-white/[0.01]">
                            <th className="px-8 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30">Sector Structure</th>
                            <th className="px-6 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-center">Oil Sensitivity</th>
                            <th className="px-6 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-center">Fiscal Risk</th>
                            <th className="px-6 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-center">Formalization</th>
                            <th className="px-6 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-center">Liquidity</th>
                            <th className="px-6 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-center">CDS Spread</th>
                            <th className="px-8 py-6 text-xs font-black uppercase tracking-[0.2em] text-white/30 text-right">Risk Pulse</th>
                        </tr>
                    </thead>
                                ...
                                <tr key={row.sector} className="group hover:bg-blue-500/[0.02] transition-all cursor-pointer" onClick={handleFilterClick}>
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="text-xs font-black text-white/30 uppercase tracking-[0.2em] mt-1">{row.companyCount} Equities</div>
                                        </div>
                                    </td>
                            ...
                            <div className="space-y-10">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="bg-white/[0.02] p-6 rounded-[2rem] border border-white/5">
                                        <div className="text-xs font-black uppercase tracking-widest text-white/30 mb-2">Transmission</div>
                                    ...
                                    <div className="bg-white/[0.02] p-6 rounded-[2rem] border border-white/5">
                                        <div className="text-xs font-black uppercase tracking-widest text-white/30 mb-2">Constituents</div>
                                ...
                                <div className="bg-blue-500/5 border border-blue-500/20 p-8 rounded-[2rem]">
                                    <h4 className="text-xs font-black uppercase tracking-widest text-blue-400 mb-4">Fundamental Driver</h4>
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-blue-400 hover:text-blue-300 transition-colors group/btn"
                                    >
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="space-y-10">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="bg-white/[0.02] p-6 rounded-[2rem] border border-white/5">
                                        <div className="text-xs font-black uppercase tracking-widest text-white/30 mb-2">5Y CDS Spread</div>
                                    ...
                                    <div className="bg-white/[0.02] p-6 rounded-[2rem] border border-white/5">
                                        <div className="text-xs font-black uppercase tracking-widest text-white/30 mb-2">30D Movement</div>
                                ...
                                <div className="bg-purple-500/5 border border-purple-500/20 p-8 rounded-[2rem]">
                                    <h4 className="text-xs font-black uppercase tracking-widest text-purple-400 mb-4">Market Sentiment</h4>
