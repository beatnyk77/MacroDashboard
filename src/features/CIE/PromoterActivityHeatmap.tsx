                ...
                {sectorStats.map((sector, i) => (
                    ...
                    >
                        <div>
                            <div className="flex justify-between items-start mb-8">
                                <div>
                                    ...
                                    <div className="text-xs font-black text-white/20 uppercase tracking-uppercase mt-1">{sector.count} Entities Monitored</div>
                                </div>
                            ...
                            <div className="space-y-8">
                                <div>
                                    <div className="flex justify-between items-end mb-3">
                                        <span className="text-xs font-black uppercase tracking-uppercase text-white/30">Insider Net Velocity</span>
                                        <span className={`text-lg font-black italic tracking-heading ${sector.netInsider >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                                ...
                                <div>
                                    <div className="flex justify-between items-end mb-3">
                                        <span className="text-xs font-black uppercase tracking-uppercase text-white/30">Avg Pledging Intensity</span>
                                        <span className={`text-lg font-black italic tracking-heading ${sector.avgPledge > 20 ? 'text-rose-400' : sector.avgPledge > 10 ? 'text-amber-400' : 'text-emerald-400'}`}>
                        ...
                        <div className="mt-10 pt-6 border-t border-white/5 flex justify-end">
                            <button className="flex items-center gap-2 text-xs font-black uppercase tracking-uppercase text-white/20 group-hover:text-blue-400 transition-all">
