            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
                ...
                <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-[10px] font-black text-amber-500 uppercase tracking-widest">Risk Index (HHI)</span>
                    </div>
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between items-end">
                            ...
                            <span className="text-[10px] font-bold text-blue-500/40 uppercase tracking-widest mb-1">India</span>
                        </div>
                        <div className="flex justify-between items-end border-t border-white/5 pt-2">
                            <span className={cn("text-3xl font-black tracking-tighter", getHHILevel(chinaHHI).color)}>
                                {Math.round(chinaHHI)}
                            </span>
                            <span className="text-[10px] font-bold text-rose-500/40 uppercase tracking-widest mb-1">China</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Dependency</span>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-4xl font-black tracking-tighter">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 px-4">
                ...
                <div className="lg:col-span-8 p-8 rounded-[2.5rem] bg-black/40 border border-white/10 backdrop-blur-xl shadow-2xl">
                    <div className="flex justify-between items-start mb-8">
                        <div className="space-y-1">
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground/40 uppercase tracking-widest">Comparison of India vs China (2000–2025)</p>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-4 p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 flex flex-col">
                    <div className="mb-8">
                        ...
                        <p className="text-[10px] font-bold text-muted-foreground/40 uppercase tracking-widest">{latestYear} Partner Share (% Share)</p>
                    </div>

                    <div className="space-y-8 flex-grow">
                        <div className="space-y-4">
                            <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">India Directives</span>
                        ...
                        <div className="space-y-4 pt-4 border-t border-white/5">
                            <span className="text-[10px] font-black text-rose-500 uppercase tracking-widest">China Directives</span>
                            <div className="space-y-3">
