...
interface IndiaEnergyMapProps {
    data: StateEnergyStats[];
    metric: keyof StateEnergyStats;
    onStateClick?: (state: StateEnergyStats) => void;
}

export const IndiaEnergyMap: React.FC<IndiaEnergyMapProps> = ({ data, metric, onStateClick }) => {
                                        ...
                                        title={
                                            <Box sx={{ p: 1 }}>
                                                ...
                                                <Typography variant="body2" sx={{ fontFamily: 'mono' }}>
                                                    {metric.replace('_', ' ').toUpperCase()}: {value.toLocaleString()}
                                                </Typography>
                                            </Box>
                                        }
                                        arrow
