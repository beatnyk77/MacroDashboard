...
export const IndiaLeafletMap: React.FC<IndiaLeafletMapProps> = ({
    ...
    if (!geoJsonData) return <div className="h-full w-full flex items-center justify-center text-white/20 uppercase tracking-widest font-black text-[0.6rem]">Loading Cartography...</div>;
