            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                        <p className="text-[0.65rem] font-black text-white/60 uppercase tracking-widest mb-4">PMI — NBS vs Caixin (12 Months)</p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={label} className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all">
                                <p className="text-[0.55rem] font-black text-muted-foreground/40 uppercase tracking-widest mb-2">{label}</p>
                    ...
                    <div className="p-5 rounded-2xl bg-gradient-to-r from-rose-500/5 via-transparent to-amber-500/5 border border-white/5">
                        <p className="text-[0.55rem] font-black text-amber-400 uppercase tracking-widest mb-2">📡 Analyst Insight</p>
