            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="Real GDP growth rate (Quarterly)"
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="Consumer Price Index (YoY % Change)"
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="RBI Policy Repo Rate"
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="Index of Industrial Production (IIP) YoY"
                    />
                </Grid>

                {/* Row 2: Secondary Macro & Reserves */}
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        label="WPI Inflation"
                        ...
                        zScoreWindow="Wholesale Price Index (YoY % Change)"
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="Retail Trade Index YoY Proxy"
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard
                        ...
                        zScoreWindow="Total Reserves excluding Gold (USD)"
                    />
                </Grid>
