...
export const IndiaInstitutionalPositioningSection: React.FC = () => {
  ...
  return <div className="space-y-8" id="institutional-positioning">
    <div className="flex items-start justify-between gap-6 flex-wrap">
      ...
      <div className={`rounded-2xl border px-5 py-4 ${tone(snapshot.regime)}`}><div className="text-[10px] uppercase tracking-[0.18em] opacity-70">Current regime</div><div className="mt-1 text-lg font-black">{snapshot.regime}</div><div className="mt-1 text-xs opacity-70">As of {snapshot.as_of_date} · {snapshot.confidence}% coverage</div></div>
    </div>
