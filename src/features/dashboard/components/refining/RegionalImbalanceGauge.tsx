        ...
        <div className={cn("p-6 rounded-[2rem] bg-black/40 border border-white/5 backdrop-blur-sm flex flex-col h-full", className)}>
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-[0.6rem] text-muted-foreground font-bold uppercase tracking-tight mt-1">West vs East Capacity Drift</p>
                </div>
                {isBreach && (
                    <div className="px-2 py-0.5 rounded bg-rose-500/20 border border-rose-500/30 text-rose-500 text-[0.5rem] font-black uppercase tracking-widest animate-pulse">
                        Critical Breach
                    </div>
                )}
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center gap-8">
                ...
                <div className="relative h-4 bg-white/5 rounded-full overflow-hidden flex">
                    ...
                    >
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 text-[0.5rem] font-black text-white/40 uppercase">West</div>
                    </motion.div>
                    <motion.div
                        initial={{ width: 0 }}
                    ...
                    >
                        <div className="absolute left-2 top-1/2 -translate-y-1/2 text-[0.5rem] font-black text-white uppercase">East</div>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-4">
                        <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                            <span className="text-[0.5rem] font-black text-muted-foreground/50 uppercase tracking-widest block mb-1">West Closures</span>
                            <div className="text-lg font-black text-rose-500 italic">
                                {west?.closure_count || 0} <span className="text-[0.6rem] not-italic opacity-40">Assets</span>
                            </div>
                        </div>
                        <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 text-right">
                            <span className="text-[0.5rem] font-black text-muted-foreground/50 uppercase tracking-widest block mb-1">Avg Utilization</span>
                    ...
                    <div className="space-y-4">
                        <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/10">
                            <span className="text-[0.5rem] font-black text-blue-500/50 uppercase tracking-widest block mb-1">East Expansion</span>
                            <div className="text-lg font-black text-blue-400 italic">
                                +{east?.expansion_count || 0} <span className="text-[0.6rem] not-italic opacity-40">Active</span>
                            </div>
                        </div>
                        <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 text-right">
                            <span className="text-[0.5rem] font-black text-muted-foreground/50 uppercase tracking-widest block mb-1">Avg Utilization</span>
            ...
            <div className="mt-8 flex items-center gap-3 p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                ...
                <p className="text-[0.6rem] text-white/50 font-bold uppercase leading-tight italic">
