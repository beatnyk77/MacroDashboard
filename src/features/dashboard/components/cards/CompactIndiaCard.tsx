        ...
        <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-white/[0.01]">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                ...
                <div className="flex flex-wrap gap-8 items-center bg-white/[0.02] p-6 rounded-xl border border-white/5">
                    <div>
                        <div className="text-xs font-bold text-muted-foreground/50 uppercase tracking-uppercase mb-1">FII Net Flow</div>
                    ...
                    <div>
                        <div className="text-xs font-bold text-muted-foreground/50 uppercase tracking-uppercase mb-1">DII Net Flow</div>
                    ...
                    <div>
                        <div className="text-xs font-bold text-muted-foreground/50 uppercase tracking-uppercase mb-1">India VIX</div>
