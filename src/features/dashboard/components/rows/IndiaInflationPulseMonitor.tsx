                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`${stickyTrend === 'ACCELERATING' ? 'text-fuchsia-400' : 'text-emerald-400'} text-[10px] font-black uppercase tracking-[0.2em]`}>
                                Sticky Trend: {stickyTrend}
                            </span>
                            <span className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] ml-2 border-l border-white/10 pl-2">Alpha Signal: Structural Trend Monitor</span>
                        </div>
            ...
            <div className="p-8 pb-12 relative">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-white/[0.03] border border-white/5 rounded-full capitalize">
                        <span className="text-[10px] font-black text-slate-500 tracking-wider">RBI Corridor: 2% - 6%</span>
                    </div>
                </div>
            ...
            <div className="p-8 bg-white/[0.02] border-t border-white/5 flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="text-[11px] font-black text-white uppercase tracking-widest">Macro Analyst Insight</h4>
                    </div>
                ...
                <div className="flex items-center gap-4 shrink-0 px-6 py-4 rounded-3xl bg-white/[0.02] border border-white/5 group-hover:border-fuchsia-500/20 transition-all duration-500">
                    <div className="flex flex-col gap-1 items-end">
                        <span className="text-[10px] font-black text-fuchsia-400 tracking-widest uppercase italic">The Divergence</span>
                        <div className="flex items-center gap-2">
                            <span className="text-xl font-black text-white">{(stickyDivergence * 100).toFixed(0)}</span>
                            <span className="text-[10px] font-black text-slate-500">BPS</span>
                        </div>
                    </div>
    ...
    if (active && payload && payload.length) {
        return (
            <div className="bg-[#0f172a]/95 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl z-50 min-w-[200px]">
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 border-b border-white/5 pb-2 italic">
                    {label}
                </div>
