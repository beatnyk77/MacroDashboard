    ...
    if (loading) {
        return (
            <div className="h-[600px] w-full bg-white/[0.02] border border-white/5 animate-pulse rounded-[3rem] flex items-center justify-center">
                <span className="text-xs font-black text-muted-foreground/30 uppercase tracking-uppercase">Mapping Fiscal Matrix...</span>
            </div>
        );
    }
            ...
            <div className="lg:col-span-2 p-8 rounded-[3rem] bg-white/[0.02] border border-white/5 relative overflow-hidden group">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-white uppercase tracking-uppercase italic">State Fiscal Health Matrix</h3>
                            <p className="text-xs text-muted-foreground/60 font-medium">Outstanding Debt vs. Fiscal Deficit (% GSDP)</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="h-[450px] w-full relative">
                    ...
                    <div className="absolute top-4 left-16 text-xs font-black text-white/20 uppercase tracking-uppercase">Debt-Driven</div>
                    <div className="absolute top-4 right-4 text-xs font-black text-rose-500/30 uppercase tracking-uppercase">Fiscal Trap (Stress)</div>
                    <div className="absolute bottom-12 left-16 text-xs font-black text-emerald-500/30 uppercase tracking-uppercase">Fiscal Fortress</div>
                    <div className="absolute bottom-12 right-4 text-xs font-black text-white/20 uppercase tracking-uppercase">Growth-Driven</div>
            ...
            <div className="flex flex-col gap-6">
                <div className="p-8 rounded-[3rem] bg-white/[0.02] border border-white/5 flex-1 relative overflow-hidden group">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h4 className="text-xs font-black text-white uppercase tracking-uppercase italic">SDL Spread Narrative</h4>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-5 rounded-2xl bg-rose-500/5 border border-rose-500/10 space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-black text-rose-500 uppercase tracking-uppercase">Stress Signal</span>
                            </div>
                        ...
                        <div className="p-5 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-black text-emerald-500 uppercase tracking-uppercase">Solvency Alpha</span>
                            </div>
                ...
                <div className="p-6 rounded-3xl bg-white/[0.01] border border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-muted-foreground/40 uppercase tracking-uppercase">Source: RBI State Finances 2024-25</span>
                    </div>
                    <div className="flex items-center gap-1">
                        <span className="text-xs font-black text-white/20 uppercase tracking-uppercase italic">Live Spread Pulse</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    if (active && payload && payload.length) {
        ...
        return (
            <div className="bg-slate-950/90 backdrop-blur-2xl border border-white/12 p-5 rounded-3xl shadow-3xl">
                <div className="text-xs font-black text-white italic mb-1 border-b border-white/5 pb-2 uppercase tracking-uppercase">
