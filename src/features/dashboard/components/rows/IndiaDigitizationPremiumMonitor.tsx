                ...
                <div className="p-8 relative">
                    ...
                    <div className="flex gap-4 mt-4">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs font-black text-slate-500 uppercase tracking-heading">Volume</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <div className="w-2 h-2 rounded-full bg-blue-500" />
                            <span className="text-xs font-black text-slate-500 uppercase tracking-heading">Value</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-8 relative">
                    ...
                    <div className="flex gap-4 mt-4">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs font-black text-slate-500 uppercase tracking-heading">India DPI Index</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <div className="w-2 h-0.5 border-b border-dashed border-white/40" />
                            <span className="text-xs font-black text-slate-500 uppercase tracking-heading">G20 Baseline</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="p-8 bg-white/[0.02] border-t border-white/5 flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="text-xs font-black text-white uppercase tracking-uppercase text-emerald-400">Structural Efficiency Narrative</h4>
                    </div>
                ...
                <div className="flex flex-col items-end gap-2 shrink-0">
                    <div className="text-xs text-slate-500 font-bold uppercase tracking-uppercase">Formalization Alpha Score</div>
                    ...
                    <span className="text-xs font-black text-emerald-400 uppercase tracking-uppercase">Tier 1 Performance</span>
                </div>
            </div>
        </section>
    );
