        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-400 font-mono mt-1">
              Speculator vs. Commercial positioning & 3-year squeeze risk telemetry
            </p>
          </div>

          <div className="flex items-center flex-wrap gap-2">
            <span className="text-[11px] font-mono bg-slate-900/90 text-cyan-400 px-2 py-0.5 border border-cyan-900/40">
              Updated: Fri 20:30 UTC
            </span>
            <MetricFreshnessChip staleness="fresh" customLabel="CFTC LIVE" />
          </div>
        </div>
      ...
      <CardContent className="p-0">
        ...
        <div className="p-4 bg-slate-950/70 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-2 text-[11px] font-mono text-slate-400">
          <div className="flex items-center space-x-2">
            ...
            <span>Rolling 156-week percentile rank of leveraged money net exposure.</span>
          </div>
          <DataProvenanceBadge
            sourceName="CFTC Financial & Disaggregated Futures"
...
const COTRowItem: React.FC<COTRowItemProps> = ({ item }) => {
  ...
  const isDeltaPositive = item.delta1wContracts >= 0;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-center">
        ...
        <div className="col-span-3">
          ...
          <div className="flex items-center space-x-2 mt-0.5">
            ...
            <span className="text-[10px] font-mono text-slate-400">
              Comm. Hedge: {item.commercialHedgeContracts > 0 ? '+' : ''}{item.commercialHedgeContracts.toLocaleString()}
            </span>
          </div>
        </div>
        ...
        <div className="col-span-3">
          <div className="flex justify-between text-[11px] font-mono mb-1">
            ...
            <span className="font-bold text-slate-200">{item.percentile3y.toFixed(1)}%</span>
          </div>
