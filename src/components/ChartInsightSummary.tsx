...
export const ChartInsightSummary: React.FC<ChartInsightSummaryProps> = ({ insight, id }) => (
    <p
        id={id}
        className="mt-4 px-4 py-3 text-xs leading-relaxed text-muted-foreground/60 font-medium border-l-2 border-blue-500/20 bg-white/[0.01] rounded-r-lg max-w-3xl"
