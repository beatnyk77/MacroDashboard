        ...
        queryFn: async (): Promise<OilData> => {
            ...
            return {
                ...
                importData: (impData || []).map((d) => ({
                    ...
                    import_cost_usd: d.import_cost_usd != null ? Number(d.import_cost_usd) : (d.brent_price_usd ? Number(d.brent_price_usd) * Number(d.import_volume_mbbl) : null),
                    import_cost_local_currency: d.import_cost_local_currency != null ? Number(d.import_cost_local_currency) : (d.brent_price_usd && d.exchange_rate ? Number(d.brent_price_usd) * Number(d.exchange_rate) : null),
                    exchange_rate: d.exchange_rate != null ? Number(d.exchange_rate) : null,
                    brent_price_usd: d.brent_price_usd != null ? Number(d.brent_price_usd) : null,
                })),
                importLastUpdated,
