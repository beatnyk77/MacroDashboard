...
export const CorporateTreasuryHedging: React.FC = () => {
    return (
        <Container maxWidth={false} sx={{ py: 6 }}>
            ...
            <Box sx={{ mb: 8 }}>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-black uppercase tracking-uppercase mb-4">
