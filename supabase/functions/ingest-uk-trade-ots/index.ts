...
async function doIngest(supabase: ReturnType<typeof createClient>, req: Request): Promise<IngestResult> {
    ...
    const hsCode = urlParams.get('hsCode') || '270900';
    ...
    // Filter records where Commodity is not null
...
serveIngest('ingest-uk-trade-ots', async (req: Request): Promise<IngestResult> => {
