...
async function doIngestRbiFxDefense(supabase: any, fredApiKey: string): Promise<IngestResult> {
...
serveIngest('ingest-rbi-fx-defense', async (_req: Request): Promise<IngestResult> => {
    ...
    return doIngestRbiFxDefense(supabase, fredApiKey)
