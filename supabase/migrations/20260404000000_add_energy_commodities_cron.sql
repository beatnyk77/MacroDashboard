...
-- Original: Created schedule_standard_cron(TEXT,TEXT,TEXT) helper (not dropped) and scheduled
--           6 energy/commodities cron jobs. Helper function superseded by canonical migration.
