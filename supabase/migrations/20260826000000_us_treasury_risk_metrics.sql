...
BEGIN
  ...
  VALUES
    ...
    ('US_TREASURY_10Y_BID_TO_COVER', '10-Year Treasury Bid-to-Cover', 'Bid-to-cover ratio for the latest 10-Year Treasury auction', fiscaldata_id, 'auction', 'auction', 'ratio', 'times', 'core', 'sovereign', 'Treasury FiscalData auction results', 14),
    ('US_TREASURY_10Y_INDIRECT_PCT', '10-Year Treasury Indirect Allotment', 'Indirect bidder share of the latest 10-Year Treasury auction', fiscaldata_id, 'auction', 'auction', '%', 'percent', 'core', 'sovereign', 'Indirect bidder accepted amount divided by total accepted amount', 14),
    ('US_TREASURY_10Y_PRIMARY_DEALER_PCT', '10-Year Treasury Primary Dealer Allotment', 'Primary dealer share of the latest 10-Year Treasury auction', fiscaldata_id, 'auction', 'auction', '%', 'percent', 'core', 'sovereign', 'Primary dealer accepted amount divided by total accepted amount', 14),
    ('US_TREASURY_10Y_DEMAND_SCORE', '10-Year Treasury Demand Score', 'Composite 10-Year auction demand score', fiscaldata_id, 'auction', 'auction', 'score', 'score', 'secondary', 'sovereign', 'Bid-to-cover multiplied by indirect bidder share', 14)
