...
DROP POLICY IF EXISTS "Public read access for trades inferred" ON institutional_trades_inferred;
...
DROP POLICY IF EXISTS "Service role full access" ON institutional_trades_inferred;
