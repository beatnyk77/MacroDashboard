...
| P3-001 | ingest | Remaining edge functions not on serveIngest; silent error swallow risk | in-progress | 2026-07-19 | Free-tier at **95 ACTIVE** after growth stack (confirm + daily brief + share-card + growth-actions). Newsletter E2E deployed. Stay ≤95; park empty slots. |
